...
$List = Get-WordPressPost -Authorization $Authorization -Tags 50, 885 -Verbose
$List | Format-Table

# List posts (default 10) with specifc tags
$List = Get-WordPressPost -Authorization $Authorization -Search 'psteams' -Verbose
$List | Format-Table

$ActualPost = Get-WordPressPost -Authorization $Authorization -Id 16698
