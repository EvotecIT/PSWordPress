@{
    ...
    FunctionsToExport    = @('Connect-Wordpress', 'Export-WordPressSnapshot', 'Get-WordPressCategory', 'Get-WordPressMedia', 'Get-WordPressPage', 'Get-WordPressPost', 'Get-WordPressSetting', 'Get-WordPressTag', 'New-WordPressPage', 'New-WordPressPost', 'Remove-WordPressPage', 'Remove-WordPressPost', 'Set-WordPressPage', 'Set-WordPressPost', 'Set-WordPressSetting')
